...
public class BindingErrorsResponse {
	...
	public void addAllErrors(BindingResult bindingResult) {
		for (FieldError fieldError : bindingResult.getFieldErrors()) {
			...
			error.setFieldValue(fieldError.getRejectedValue()==null? "null": fieldError.getRejectedValue().toString());
	...
	public String toString() {
		return "BindingErrors [bindingErrors=" + bindingErrors + "]";
	}
	...
	protected class BindingError {
		...
		@Override
		public String toString() {
			return "BindingError [nameOfObject=" + objectName + ", Field=" + fieldName + ", Value=" + fieldValue
